...
General:AddSection("| Auto Farm Mods")
AddDropdownS(General, "Select Mods", "", MonList, Settings.SelectMobs, true, "SelectMobs")
AddToggle(General, "Auto Farm Mods", "", Settings.AutoFarmMods, "AutoFarmMods")
